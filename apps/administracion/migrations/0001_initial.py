            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        verbose_name="Cantidad de combustible máx. (En litros)",
                    ),
                ),
                (
                    "codigo_bn",
                ...
                (
                    "asignado",
                    models.CharField(
                        choices=[("si", "Si"), ("no", "No")], default="no", max_length=8
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        verbose_name="N° de orden",
                    ),
                ),
                (
                    "valor_bs",
                    models.TextField(
                        validators=[helpers.validForm.CurrencyValidator()],
                        verbose_name="Valor en BS",
                    ),
                ),
                (
                    "articulo",
