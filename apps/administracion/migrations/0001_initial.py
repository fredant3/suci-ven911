# Generated by Django 5.1.1 on 2025-03-30 20:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_combustible', models.IntegerField(blank=True, null=True, verbose_name='Cantidad de combustible máx. (En litros)')),
                ...
                ('condicion', models.CharField(choices=[('N', 'Nuevo'), ('U', 'Usado'), ('D', 'Deteriorado'), ('-', 'No Aplica')], default='-', max_length=1, verbose_name='Condición')),
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('listar_departamento', 'Puede listar departamentos'), ('agregar_departamento', 'Puede agregar departamento'), ('ver_departamento', 'Puede ver departamento'), ('editar_departamento', 'Puede actualizar departamento'), ('eliminar_departamento', 'Puede eliminar departamento')],
            },
        ),
        migrations.CreateModel(
            name='Sede',
            fields=[
                ...
                ('estatus', models.CharField(choices=[('act', 'Activo'), ('rem', 'Remodelacion'), ('cer', 'Cerrada')], max_length=3, verbose_name='Estatus')),
            ],
            options={
                'verbose_name': 'sede',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.CharField(blank=True, max_length=6, null=True, verbose_name='Eliminado por')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Eliminado el')),
                ('n_orden', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), helpers.validForm.PositiveIntegerValidator()], verbose_name='N° de orden')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.TextField(max_length=255, validators=[django.core.validators.MinLengthValidator(10), django.core.validators.MaxLengthValidator(255), helpers.validForm.TextValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.CharField(blank=True, max_length=6, null=True, verbose_name='Eliminado por')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Eliminado el')),
                ('problema', models.TextField(max_length=180, validators=[django.core.validators.MinLengthValidator(9), django.core.validators.MaxLengthValidator(180), helpers.validForm.TextValidator()], verbose_name='Problema')),
