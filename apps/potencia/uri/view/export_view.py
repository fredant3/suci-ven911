    ...
    def get(self, request, *args, **kwargs):
        ...
        for uri in uris:
            row = [
                ...
                uri.tipounidad,
                uri.num_interna,
                self.get_choice_display(uri.contacto, ESTATUS_CHOICES),
                uri.centroAsistencial,
                ...
                # 5) Información Clínica - Trauma
                self.get_choice_display(uri.accidenteVehicular, ESTATUS_CHOICES2),
                self.get_choice_display(uri.enfrentamientoArmado, ESTATUS_CHOICES2),
                self.get_choice_display(uri.traumaVehiculo, ESTATUS_CHOICES2),
