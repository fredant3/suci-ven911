# Generated by Django 5.1.1 on 2025-02-09 19:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('centroAsistencial', models.CharField(blank=True, max_length=50, null=True)),
                ('servicioAsistencial', models.CharField(blank=True, max_length=50, null=True)),
                ('medico_receptor', models.CharField(blank=True, max_length=50, null=True)),
                ('msds', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('generopaciente', models.CharField(blank=True, max_length=10, null=True, verbose_name='Genero del Paciente')),
                ...
                ('genero_acompanante', models.CharField(blank=True, max_length=10, null=True, verbose_name='Genero del acompañante')),
                ...
                ('estado_evento', models.CharField(blank=True, max_length=20, null=True, verbose_name='Estado')),
                ...
                ('sector_evento', models.CharField(blank=True, max_length=300, null=True, verbose_name='Sector/Urbanizacion')),
                ('calle_evento', models.CharField(blank=True, max_length=300, null=True, verbose_name='Calle/Avenida/Carrera')),
                ...
                ('referencia_evento', models.CharField(blank=True, max_length=300, null=True, verbose_name='Punto de Referencia')),
                ...
                ('horaMedicion', models.CharField(blank=True, max_length=100, null=True, verbose_name='Hora de la Medición')),
                ...
                ('glicemiaCapilar', models.CharField(blank=True, max_length=100, null=True, verbose_name='Glicemia Capillar')),
