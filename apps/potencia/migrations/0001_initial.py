    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(max_length=120, validators=[django.core.validators.MinLengthValidator(9), django.core.validators.MaxLengthValidator(120), helpers.validForm.TextValidator()], verbose_name='Tipo de Incidencia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generopaciente', models.CharField(blank=True, choices=[('Femenino', 'Femenino'), ('Masculino', 'Masculino')], max_length=9, null=True, verbose_name='Genero del Paciente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.CharField(max_length=200, validators=[django.core.validators.MinLengthValidator(5), django.core.validators.MaxLengthValidator(2800), helpers.validForm.TextValidator()], verbose_name='Descripción de la falla')),
