    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "permissions": [
                    (
                        "listar_tipo_incidencia_emergencia",
                        "Puede listar tipo incidencia",
                    ),
                    (
                        "agregar_tipo_incidencia_emergencia",
                        "Puede agregar tipo incidencia",
                    ),
                    ("ver_tipo_incidencia_emergencia", "Puede ver tipo incidencia"),
                    (
                        "editar_tipo_incidencia_emergencia",
                        "Puede actualizar tipo incidencia",
                    ),
                    (
                        "eliminar_tipo_incidencia_emergencia",
                        "Puede eliminar tipo incidencia",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "municipio",
                    models.CharField(max_length=90, verbose_name="Municipio"),
                ),
                (
                    "parroquia",
                    models.CharField(max_length=90, verbose_name="Parroquia"),
                ),
                (
                    ...
                    models.TextField(
                        ...
                        verbose_name="Dirección de la incidencia",
                    ),
                ),
                (
                    "observaciones",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        verbose_name="Teléfono del Cuadrente de Paz",
                    ),
                ),
                (
                    "organismo",
