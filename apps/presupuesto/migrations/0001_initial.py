    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacion_presupuestaria', models.CharField(max_length=64, verbose_name='Situación Presupuestaria:')),
                ('monto', models.CharField(max_length=64, verbose_name='Monto Total del Proyecto:')),
                ('responsable_gerente', models.CharField(max_length=64, verbose_name='Responsable Gerente:')),
                ('responsable_tecnico', models.CharField(max_length=64, verbose_name='Responsable Técnico:')),
                ('responsable_registrador', models.CharField(max_length=64, verbose_name='Responsable Registrador:')),
                ('responsable_administrativo', models.CharField(max_length=64, verbose_name='Responsable Administrativo:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.CharField(blank=True, max_length=6, null=True, verbose_name='Eliminado por')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Eliminado el')),
                ('departamento', models.CharField(max_length=64, verbose_name='Nombre de la dirección:')),
                ('presupuesto', models.CharField(max_length=64, verbose_name='Presupuesto asignado:')),
                ('objetivo', models.CharField(max_length=64, verbose_name='Objetivo general anual:')),
                ('numero_partida', models.CharField(max_length=10, verbose_name='Número de partida:')),
            ],
            options={
